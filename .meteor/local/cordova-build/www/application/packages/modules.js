...
}}}}}},"iphone-inline-video":{"package.json":function(require,exports){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                 //
// node_modules/iphone-inline-video/package.json                                                                   //
//                                                                                                                 //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                   //
exports.name = "iphone-inline-video";                                                                              // 1
exports.version = "1.9.3";                                                                                         // 2
exports.main = "dist/iphone-inline-video.common-js.js";                                                            // 3
                                                                                                                   // 4
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"dist":{"iphone-inline-video.common-js.js":["poor-mans-symbol",function(require,exports,module){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                   //
/*! npm.im/iphone-inline-video */                                                                                  // 1
'use strict';                                                                                                      // 2
                                                                                                                   // 3
function _interopDefault (ex) { return (ex && (typeof ex === 'object') && 'default' in ex) ? ex['default'] : ex; }
                                                                                                                   // 5
var Symbol = _interopDefault(require('poor-mans-symbol'));                                                         // 6
                                                                                                                   // 7
function Intervalometer(cb) {                                                                                      // 8
	var rafId;                                                                                                        // 9
	var previousLoopTime;                                                                                             // 10
	function loop(now) {                                                                                              // 11
		// must be requested before cb() because that might call .stop()                                                 // 12
		rafId = requestAnimationFrame(loop);                                                                             // 13
		cb(now - (previousLoopTime || now)); // ms since last call. 0 on start()                                         // 14
		previousLoopTime = now;                                                                                          // 15
	}                                                                                                                 // 16
	this.start = function () {                                                                                        // 17
		if (!rafId) { // prevent double starts                                                                           // 18
			loop(0);                                                                                                        // 19
		}                                                                                                                // 20
	};                                                                                                                // 21
	this.stop = function () {                                                                                         // 22
		cancelAnimationFrame(rafId);                                                                                     // 23
		rafId = null;                                                                                                    // 24
		previousLoopTime = 0;                                                                                            // 25
	};                                                                                                                // 26
}                                                                                                                  // 27
                                                                                                                   // 28
function preventEvent(element, eventName, toggleProperty, preventWithProperty) {                                   // 29
	function handler(e) {                                                                                             // 30
		if (Boolean(element[toggleProperty]) === Boolean(preventWithProperty)) {                                         // 31
			e.stopImmediatePropagation();                                                                                   // 32
			// console.log(eventName, 'prevented on', element);                                                             // 33
		}                                                                                                                // 34
		delete element[toggleProperty];                                                                                  // 35
	}                                                                                                                 // 36
	element.addEventListener(eventName, handler, false);                                                              // 37
                                                                                                                   // 38
	// Return handler to allow to disable the prevention. Usage:                                                      // 39
	// const preventionHandler = preventEvent(el, 'click');                                                           // 40
	// el.removeEventHandler('click', preventionHandler);                                                             // 41
	return handler;                                                                                                   // 42
}                                                                                                                  // 43
                                                                                                                   // 44
function proxyProperty(object, propertyName, sourceObject, copyFirst) {                                            // 45
	function get() {                                                                                                  // 46
		return sourceObject[propertyName];                                                                               // 47
	}                                                                                                                 // 48
	function set(value) {                                                                                             // 49
		sourceObject[propertyName] = value;                                                                              // 50
	}                                                                                                                 // 51
                                                                                                                   // 52
	if (copyFirst) {                                                                                                  // 53
		set(object[propertyName]);                                                                                       // 54
	}                                                                                                                 // 55
                                                                                                                   // 56
	Object.defineProperty(object, propertyName, {get: get, set: set});                                                // 57
}                                                                                                                  // 58
                                                                                                                   // 59
function proxyEvent(object, eventName, sourceObject) {                                                             // 60
	sourceObject.addEventListener(eventName, function () { return object.dispatchEvent(new Event(eventName)); });     // 61
}                                                                                                                  // 62
                                                                                                                   // 63
function dispatchEventAsync(element, type) {                                                                       // 64
	Promise.resolve().then(function () {                                                                              // 65
		element.dispatchEvent(new Event(type));                                                                          // 66
	});                                                                                                               // 67
}                                                                                                                  // 68
                                                                                                                   // 69
// iOS 10 adds support for native inline playback + silent autoplay                                                // 70
// Also adds unprefixed css-grid. This check essentially excludes                                                  // 71
var isWhitelisted = /iPhone|iPod/i.test(navigator.userAgent) && document.head.style.grid === undefined;            // 72
                                                                                                                   // 73
var ಠ = Symbol();                                                                                                  // 74
var ಠevent = Symbol();                                                                                             // 75
var ಠplay = Symbol('nativeplay');                                                                                  // 76
var ಠpause = Symbol('nativepause');                                                                                // 77
                                                                                                                   // 78
/**                                                                                                                // 79
 * UTILS                                                                                                           // 80
 */                                                                                                                // 81
                                                                                                                   // 82
function getAudioFromVideo(video) {                                                                                // 83
	var audio = new Audio();                                                                                          // 84
	proxyEvent(video, 'play', audio);                                                                                 // 85
	proxyEvent(video, 'playing', audio);                                                                              // 86
	proxyEvent(video, 'pause', audio);                                                                                // 87
	audio.crossOrigin = video.crossOrigin;                                                                            // 88
                                                                                                                   // 89
	// 'data:' causes audio.networkState > 0                                                                          // 90
	// which then allows to keep <audio> in a resumable playing state                                                 // 91
	// i.e. once you set a real src it will keep playing if it was if .play() was called                              // 92
	audio.src = video.src || video.currentSrc || 'data:';                                                             // 93
                                                                                                                   // 94
	// if (audio.src === 'data:') {                                                                                   // 95
	//   TODO: wait for video to be selected                                                                          // 96
	// }                                                                                                              // 97
	return audio;                                                                                                     // 98
}                                                                                                                  // 99
                                                                                                                   // 100
var lastRequests = [];                                                                                             // 101
var requestIndex = 0;                                                                                              // 102
var lastTimeupdateEvent;                                                                                           // 103
                                                                                                                   // 104
function setTime(video, time, rememberOnly) {                                                                      // 105
	// allow one timeupdate event every 200+ ms                                                                       // 106
	if ((lastTimeupdateEvent || 0) + 200 < Date.now()) {                                                              // 107
		video[ಠevent] = true;                                                                                            // 108
		lastTimeupdateEvent = Date.now();                                                                                // 109
	}                                                                                                                 // 110
	if (!rememberOnly) {                                                                                              // 111
		video.currentTime = time;                                                                                        // 112
	}                                                                                                                 // 113
	lastRequests[++requestIndex % 3] = time * 100 | 0 / 100;                                                          // 114
}                                                                                                                  // 115
                                                                                                                   // 116
function isPlayerEnded(player) {                                                                                   // 117
	return player.driver.currentTime >= player.video.duration;                                                        // 118
}                                                                                                                  // 119
                                                                                                                   // 120
function update(timeDiff) {                                                                                        // 121
	var player = this;                                                                                                // 122
	// console.log('update', player.video.readyState, player.video.networkState, player.driver.readyState, player.driver.networkState, player.driver.paused);
	if (player.video.readyState >= player.video.HAVE_FUTURE_DATA) {                                                   // 124
		if (!player.hasAudio) {                                                                                          // 125
			player.driver.currentTime = player.video.currentTime + (timeDiff * player.video.playbackRate) / 1000;           // 126
			if (player.video.loop && isPlayerEnded(player)) {                                                               // 127
				player.driver.currentTime = 0;                                                                                 // 128
			}                                                                                                               // 129
		}                                                                                                                // 130
		setTime(player.video, player.driver.currentTime);                                                                // 131
	} else if (player.video.networkState === player.video.NETWORK_IDLE && !player.video.buffered.length) {            // 132
		// this should happen when the source is available but:                                                          // 133
		// - it's potentially playing (.paused === false)                                                                // 134
		// - it's not ready to play                                                                                      // 135
		// - it's not loading                                                                                            // 136
		// If it hasAudio, that will be loaded in the 'emptied' handler below                                            // 137
		player.video.load();                                                                                             // 138
		// console.log('Will load');                                                                                     // 139
	}                                                                                                                 // 140
                                                                                                                   // 141
	// console.assert(player.video.currentTime === player.driver.currentTime, 'Video not updating!');                 // 142
                                                                                                                   // 143
	if (player.video.ended) {                                                                                         // 144
		delete player.video[ಠevent]; // allow timeupdate event                                                           // 145
		player.video.pause(true);                                                                                        // 146
	}                                                                                                                 // 147
}                                                                                                                  // 148
                                                                                                                   // 149
/**                                                                                                                // 150
 ...
 */                                                                                                                // 152
                                                                                                                   // 153
function play() {                                                                                                  // 154
	// console.log('play');                                                                                           // 155
	var video = this;                                                                                                 // 156
	var player = video[ಠ];                                                                                            // 157
                                                                                                                   // 158
	// if it's fullscreen, use the native player                                                                      // 159
	if (video.webkitDisplayingFullscreen) {                                                                           // 160
		video[ಠplay]();                                                                                                  // 161
		return;                                                                                                          // 162
	}                                                                                                                 // 163
                                                                                                                   // 164
	if (player.driver.src !== 'data:' && player.driver.src !== video.src) {                                           // 165
		// console.log('src changed on play', video.src);                                                                // 166
		setTime(video, 0, true);                                                                                         // 167
		player.driver.src = video.src;                                                                                   // 168
	}                                                                                                                 // 169
                                                                                                                   // 170
	if (!video.paused) {                                                                                              // 171
		return;                                                                                                          // 172
	}                                                                                                                 // 173
	player.paused = false;                                                                                            // 174
                                                                                                                   // 175
	if (!video.buffered.length) {                                                                                     // 176
		// .load() causes the emptied event                                                                              // 177
		// the alternative is .play()+.pause() but that triggers play/pause events, even worse                           // 178
		// possibly the alternative is preventing this event only once                                                   // 179
		video.load();                                                                                                    // 180
	}                                                                                                                 // 181
                                                                                                                   // 182
	player.driver.play();                                                                                             // 183
	player.updater.start();                                                                                           // 184
                                                                                                                   // 185
	if (!player.hasAudio) {                                                                                           // 186
		dispatchEventAsync(video, 'play');                                                                               // 187
		if (player.video.readyState >= player.video.HAVE_ENOUGH_DATA) {                                                  // 188
			// console.log('onplay');                                                                                       // 189
			dispatchEventAsync(video, 'playing');                                                                           // 190
		}                                                                                                                // 191
	}                                                                                                                 // 192
}                                                                                                                  // 193
function pause(forceEvents) {                                                                                      // 194
	// console.log('pause');                                                                                          // 195
	var video = this;                                                                                                 // 196
	var player = video[ಠ];                                                                                            // 197
                                                                                                                   // 198
	player.driver.pause();                                                                                            // 199
	player.updater.stop();                                                                                            // 200
                                                                                                                   // 201
	// if it's fullscreen, the developer the native player.pause()                                                    // 202
	// This is at the end of pause() because it also                                                                  // 203
	// needs to make sure that the simulation is paused                                                               // 204
	if (video.webkitDisplayingFullscreen) {                                                                           // 205
		video[ಠpause]();                                                                                                 // 206
	}                                                                                                                 // 207
                                                                                                                   // 208
	if (player.paused && !forceEvents) {                                                                              // 209
		return;                                                                                                          // 210
	}                                                                                                                 // 211
                                                                                                                   // 212
	player.paused = true;                                                                                             // 213
	if (!player.hasAudio) {                                                                                           // 214
		dispatchEventAsync(video, 'pause');                                                                              // 215
	}                                                                                                                 // 216
	if (video.ended) {                                                                                                // 217
		video[ಠevent] = true;                                                                                            // 218
		dispatchEventAsync(video, 'ended');                                                                              // 219
	}                                                                                                                 // 220
}                                                                                                                  // 221
                                                                                                                   // 222
/**                                                                                                                // 223
 ...
 */                                                                                                                // 225
                                                                                                                   // 226
function addPlayer(video, hasAudio) {                                                                              // 227
	var player = video[ಠ] = {};                                                                                       // 228
	player.paused = true; // track whether 'pause' events have been fired                                             // 229
	player.hasAudio = hasAudio;                                                                                       // 230
	player.video = video;                                                                                             // 231
	player.updater = new Intervalometer(update.bind(player));                                                         // 232
                                                                                                                   // 233
	if (hasAudio) {                                                                                                   // 234
		player.driver = getAudioFromVideo(video);                                                                        // 235
	} else {                                                                                                          // 236
		video.addEventListener('canplay', function () {                                                                  // 237
			if (!video.paused) {                                                                                            // 238
				// console.log('oncanplay');                                                                                   // 239
				dispatchEventAsync(video, 'playing');                                                                          // 240
			}                                                                                                               // 241
		});                                                                                                              // 242
		player.driver = {                                                                                                // 243
			src: video.src || video.currentSrc || 'data:',                                                                  // 244
			muted: true,                                                                                                    // 245
			paused: true,                                                                                                   // 246
			pause: function () {                                                                                            // 247
				player.driver.paused = true;                                                                                   // 248
			},                                                                                                              // 249
			play: function () {                                                                                             // 250
				player.driver.paused = false;                                                                                  // 251
				// media automatically goes to 0 if .play() is called when it's done                                           // 252
				if (isPlayerEnded(player)) {                                                                                   // 253
					setTime(video, 0);                                                                                            // 254
				}                                                                                                              // 255
			},                                                                                                              // 256
			get ended() {                                                                                                   // 257
				return isPlayerEnded(player);                                                                                  // 258
			}                                                                                                               // 259
		};                                                                                                               // 260
	}                                                                                                                 // 261
                                                                                                                   // 262
	// .load() causes the emptied event                                                                               // 263
	video.addEventListener('emptied', function () {                                                                   // 264
		// console.log('driver src is', player.driver.src);                                                              // 265
		var wasEmpty = !player.driver.src || player.driver.src === 'data:';                                              // 266
		if (player.driver.src && player.driver.src !== video.src) {                                                      // 267
			// console.log('src changed to', video.src);                                                                    // 268
			setTime(video, 0, true);                                                                                        // 269
			player.driver.src = video.src;                                                                                  // 270
			// playing videos will only keep playing if no src was present when .play()’ed                                  // 271
			if (wasEmpty) {                                                                                                 // 272
				player.driver.play();                                                                                          // 273
			} else {                                                                                                        // 274
				player.updater.stop();                                                                                         // 275
			}                                                                                                               // 276
		}                                                                                                                // 277
	}, false);                                                                                                        // 278
                                                                                                                   // 279
	// stop programmatic player when OS takes over                                                                    // 280
	video.addEventListener('webkitbeginfullscreen', function () {                                                     // 281
		if (!video.paused) {                                                                                             // 282
			// make sure that the <audio> and the syncer/updater are stopped                                                // 283
			video.pause();                                                                                                  // 284
                                                                                                                   // 285
			// play video natively                                                                                          // 286
			video[ಠplay]();                                                                                                 // 287
		} else if (hasAudio && !player.driver.buffered.length) {                                                         // 288
			// if the first play is native,                                                                                 // 289
			// the <audio> needs to be buffered manually                                                                    // 290
			// so when the fullscreen ends, it can be set to the same current time                                          // 291
			player.driver.load();                                                                                           // 292
		}                                                                                                                // 293
	});                                                                                                               // 294
	if (hasAudio) {                                                                                                   // 295
		video.addEventListener('webkitendfullscreen', function () {                                                      // 296
			// sync audio to new video position                                                                             // 297
			player.driver.currentTime = video.currentTime;                                                                  // 298
			// console.assert(player.driver.currentTime === video.currentTime, 'Audio not synced');                         // 299
		});                                                                                                              // 300
                                                                                                                   // 301
		// allow seeking                                                                                                 // 302
		video.addEventListener('seeking', function () {                                                                  // 303
			if (lastRequests.indexOf(video.currentTime * 100 | 0 / 100) < 0) {                                              // 304
				// console.log('User-requested seeking');                                                                      // 305
				player.driver.currentTime = video.currentTime;                                                                 // 306
			}                                                                                                               // 307
		});                                                                                                              // 308
	}                                                                                                                 // 309
}                                                                                                                  // 310
                                                                                                                   // 311
function overloadAPI(video) {                                                                                      // 312
	var player = video[ಠ];                                                                                            // 313
	video[ಠplay] = video.play;                                                                                        // 314
	video[ಠpause] = video.pause;                                                                                      // 315
	video.play = play;                                                                                                // 316
	video.pause = pause;                                                                                              // 317
	proxyProperty(video, 'paused', player.driver);                                                                    // 318
	proxyProperty(video, 'muted', player.driver, true);                                                               // 319
	proxyProperty(video, 'playbackRate', player.driver, true);                                                        // 320
	proxyProperty(video, 'ended', player.driver);                                                                     // 321
	proxyProperty(video, 'loop', player.driver, true);                                                                // 322
	preventEvent(video, 'seeking');                                                                                   // 323
	preventEvent(video, 'seeked');                                                                                    // 324
	preventEvent(video, 'timeupdate', ಠevent, false);                                                                 // 325
	preventEvent(video, 'ended', ಠevent, false); // prevent occasional native ended events                            // 326
}                                                                                                                  // 327
                                                                                                                   // 328
function enableInlineVideo(video, hasAudio, onlyWhitelisted) {                                                     // 329
	if ( hasAudio === void 0 ) hasAudio = true;                                                                       // 330
	if ( onlyWhitelisted === void 0 ) onlyWhitelisted = true;                                                         // 331
                                                                                                                   // 332
	if ((onlyWhitelisted && !isWhitelisted) || video[ಠ]) {                                                            // 333
		return;                                                                                                          // 334
	}                                                                                                                 // 335
	addPlayer(video, hasAudio);                                                                                       // 336
	overloadAPI(video);                                                                                               // 337
	video.classList.add('IIV');                                                                                       // 338
	if (!hasAudio && video.autoplay) {                                                                                // 339
		video.play();                                                                                                    // 340
	}                                                                                                                 // 341
	if (navigator.platform === 'MacIntel' || navigator.platform === 'Windows') {                                      // 342
		console.warn('iphone-inline-video is not guaranteed to work in emulated environments');                          // 343
	}                                                                                                                 // 344
}                                                                                                                  // 345
                                                                                                                   // 346
enableInlineVideo.isWhitelisted = isWhitelisted;                                                                   // 347
                                                                                                                   // 348
module.exports = enableInlineVideo;                                                                                // 349
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

}]}},"poor-mans-symbol":{"package.json":function(require,exports){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                 //
// node_modules/poor-mans-symbol/package.json                                                                      //
//                                                                                                                 //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                   //
exports.name = "poor-mans-symbol";                                                                                 // 1
exports.version = "1.0.1";                                                                                         // 2
exports.main = "dist/poor-mans-symbol.common-js.js";                                                               // 3
                                                                                                                   // 4
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

},"dist":{"poor-mans-symbol.common-js.js":function(require,exports,module){

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                 //
// node_modules/poor-mans-symbol/dist/poor-mans-symbol.common-js.js                                                //
//                                                                                                                 //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                   //
'use strict';                                                                                                      // 1
                                                                                                                   // 2
var index = typeof Symbol === 'undefined' ? function (description) {                                               // 3
	return '@' + (description || '@') + Math.random();                                                                // 4
} : Symbol;                                                                                                        // 5
                                                                                                                   // 6
